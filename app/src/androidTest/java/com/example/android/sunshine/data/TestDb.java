...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error: cannot move to first row", c.moveToFirst());
        TestUtilities.validateCurrentRecord(new String("Error: Cursor not valid"), c, TestUtilities.createNorthPoleLocationValues());
        assertFalse("Error: more than one row in database", c.moveToNext());
